...
L["ATLAS_DDL_CONTINENT_EASTERN"] = "Instances - Eastern Kingdoms"
L["ATLAS_DDL_CONTINENT_KALIMDOR"] = "Instances - Kalimdor"
...
L["ATLAS_DDL_FLIGHTROUTES"] = "Flight Routes / Ships / Zeppelins"
L["ATLAS_DDL_FLIGHTROUTES_ALLIANCE"] = "Alliance Flight Routes"
L["ATLAS_DDL_FLIGHTROUTES_HORDE"] = "Horde Flight Routes"
L["ATLAS_DDL_FLIGHTROUTES_SHIPS"] = "Ship Routes"
L["ATLAS_FLIGHTROUTES_FLIGHT_MASTER"] = "Flight Master"
L["ATLAS_FLIGHTROUTES_SHIP_MASTER"] = "Ship Master"
L["ATLAS_FLIGHTROUTES_ALLIANCE_EAST"] = "Alliance Flights - Eastern Kingdoms"
L["ATLAS_FLIGHTROUTES_ALLIANCE_WEST"] = "Alliance Flights - Kalimdor"
L["ATLAS_FLIGHTROUTES_HORDE_EAST"] = "Horde Flights - Eastern Kingdoms"
L["ATLAS_FLIGHTROUTES_HORDE_WEST"] = "Horde Flights - Kalimdor"
L["ATLAS_FLIGHTROUTES_SHIP_ROUTES"] = "Ship Routes"
L["ATLAS_FLIGHTROUTES_SHIP_ALLIANCE"] = "Ships - Alliance"
L["ATLAS_FLIGHTROUTES_SHIP_HORDE"] = "Ships - Horde"
...
L["ATLAS_FOREVER_HALL_OF_THANES"] = "Hall of Thanes (Forever)"
L["ATLAS_FOREVER_RUINS_OF_LORDAERON"] = "Ruins of Lordaeron (Forever)"
L["ATLAS_FOREVER_DALARAN_CITY"] = "Dalaran City (Forever)"
L["ATLAS_FOREVER_HALL_OF_THANES_LOC"] = "Deep Below Ironforge"
L["ATLAS_FOREVER_RUINS_OF_LORDAERON_LOC"] = "Tirisfal Glades"
L["ATLAS_FOREVER_DALARAN_CITY_LOC"] = "Alterac Mountains"
L["ATLAS_FOREVER_HALL_OF_THANES_DESC"] = "Beneath the dwarven city, in old Ironforge, lie the halls where the thanes of old rest. Something has awakened down there and the dwarves are none too pleased."
L["ATLAS_FOREVER_RUINS_OF_LORDAERON_DESC"] = "What remains of the kingdom of Lordaeron above Undercity. Among the rubble of the palace enemies still lurk, and the Forsaken want the city back."
L["ATLAS_FOREVER_DALARAN_CITY_DESC"] = "The barrier that protected Dalaran has fallen. The city is rebuilt, but not entirely under control, and the Kirin Tor need someone to restore order."
...
L["ATLAS_HTGT_RAZORFEN_LOC"] = "Southern Barrens"
L["ATLAS_HTGT_SHADOWFANG_LOC"] = "Silverpine Forest"
L["ATLAS_HTGT_STOCKADE_LOC"] = "Stormwind City"
L["ATLAS_HTGT_WAILING_LOC"] = "Northern Barrens"
L["ATLAS_DDL_HTGT"] = "How to Get There"
L["ATLAS_FOREVER_EXCAVATION_SITE"] = "Excavation Site (Forever)"
L["ATLAS_FOREVER_EXCAVATION_SITE_LOC"] = "Eastern Kingdoms"
