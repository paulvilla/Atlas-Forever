...
L["ATLAS_DDL_FLIGHTROUTES"] = "Маршруты полета / Корабли / Дирижабли"
L["ATLAS_DDL_FLIGHTROUTES_ALLIANCE"] = "Маршруты полета Альянса"
L["ATLAS_DDL_FLIGHTROUTES_HORDE"] = "Маршруты полета Орды"
L["ATLAS_DDL_FLIGHTROUTES_SHIPS"] = "Маршруты кораблей"
L["ATLAS_FLIGHTROUTES_FLIGHT_MASTER"] = "Мастер полета"
L["ATLAS_FLIGHTROUTES_SHIP_MASTER"] = "Мастер корабля"
L["ATLAS_FLIGHTROUTES_ALLIANCE_EAST"] = "Полеты Альянса - Восточные королевства"
L["ATLAS_FLIGHTROUTES_ALLIANCE_WEST"] = "Полеты Альянса - Калимдор"
L["ATLAS_FLIGHTROUTES_HORDE_EAST"] = "Полеты Орды - Восточные королевства"
L["ATLAS_FLIGHTROUTES_HORDE_WEST"] = "Полеты Орды - Калимдор"
L["ATLAS_FLIGHTROUTES_SHIP_ROUTES"] = "Маршруты кораблей"
L["ATLAS_FLIGHTROUTES_SHIP_ALLIANCE"] = "Корабли - Альянс"
L["ATLAS_FLIGHTROUTES_SHIP_HORDE"] = "Корабли - Орда"
...
L["ATLAS_FOREVER_HALL_OF_THANES"] = "Зал Танов (Forever)"
L["ATLAS_FOREVER_RUINS_OF_LORDAERON"] = "Руины Лордерона (Forever)"
L["ATLAS_FOREVER_DALARAN_CITY"] = "Даларан (Forever)"
L["ATLAS_FOREVER_HALL_OF_THANES_LOC"] = "Глубже Под Стальгорном"
L["ATLAS_FOREVER_RUINS_OF_LORDAERON_LOC"] = "Тирисфальские леса"
L["ATLAS_FOREVER_DALARAN_CITY_LOC"] = "Альтеракские горы"
L["ATLAS_FOREVER_HALL_OF_THANES_DESC"] = "Под городом дворфов, в старой Стальгорне, открываются залы, где покоятся таны былого. Что-то пробудилось там внизу, и дворфам это совсем не нравится."
L["ATLAS_FOREVER_RUINS_OF_LORDAERON_DESC"] = "То, что осталось от королевства Лордерон над Подгородом. Среди обломков дворца всё ещё таится враг, а Отрекшиеся хотят вернуть город."
L["ATLAS_FOREVER_DALARAN_CITY_DESC"] = "Барьер, защищавший Даларан, пал. Город восстановлен, но не полностью под контролем, и Кирин-Тор нужен кто-то, кто наведёт порядок."
...
L["ATLAS_HTGT_BLACKFATHOM_LOC"] = "Ясеневый лес"
L["ATLAS_HTGT_RAGEFIRE_LOC"] = "Оргриммар"
L["ATLAS_HTGT_RAZORFEN_LOC"] = "Южные Степи"
L["ATLAS_HTGT_SHADOWFANG_LOC"] = "Серебряный бор"
L["ATLAS_HTGT_STOCKADE_LOC"] = "Штормград"
L["ATLAS_HTGT_WAILING_LOC"] = "Северные Степи"
L["ATLAS_DDL_HTGT"] = "Как добраться"
L["ATLAS_FOREVER_EXCAVATION_SITE"] = "Раскопки (Forever)"
L["ATLAS_FOREVER_EXCAVATION_SITE_LOC"] = "Восточные королевства"
