...
-- How to Get There Category
ATLAS_DDL_HTGT               = L["ATLAS_DDL_HTGT"]

-- Flight Routes / Ships / Zeppelins Category
ATLAS_DDL_FLIGHTROUTES       = L["ATLAS_DDL_FLIGHTROUTES"]
ATLAS_DDL_FLIGHTROUTES_ALLIANCE = L["ATLAS_DDL_FLIGHTROUTES_ALLIANCE"]
ATLAS_DDL_FLIGHTROUTES_HORDE = L["ATLAS_DDL_FLIGHTROUTES_HORDE"]
ATLAS_DDL_FLIGHTROUTES_SHIPS = L["ATLAS_DDL_FLIGHTROUTES_SHIPS"]
ATLAS_FLIGHTROUTES_SHIP_ALLIANCE = L["ATLAS_FLIGHTROUTES_SHIP_ALLIANCE"]
ATLAS_FLIGHTROUTES_SHIP_HORDE = L["ATLAS_FLIGHTROUTES_SHIP_HORDE"]
