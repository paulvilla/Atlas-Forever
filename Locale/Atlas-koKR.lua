...
L["ATLAS_DDL_CONTINENT_EASTERN"] = "인스턴스 - 동부 왕국"
L["ATLAS_DDL_CONTINENT_KALIMDOR"] = "인스턴스 - 칼림도어"
...
L["ATLAS_DDL_FLIGHTROUTES"] = "비행 경로 / 배 / 비행선"
L["ATLAS_DDL_FLIGHTROUTES_ALLIANCE"] = "얼라이언스 비행 경로"
L["ATLAS_DDL_FLIGHTROUTES_HORDE"] = "호드 비행 경로"
L["ATLAS_DDL_FLIGHTROUTES_SHIPS"] = "배 경로"
L["ATLAS_FLIGHTROUTES_FLIGHT_MASTER"] = "비행 마스터"
L["ATLAS_FLIGHTROUTES_SHIP_MASTER"] = "배 마스터"
L["ATLAS_FLIGHTROUTES_ALLIANCE_EAST"] = "얼라이언스 비행 - 동부 왕국"
L["ATLAS_FLIGHTROUTES_ALLIANCE_WEST"] = "얼라이언스 비행 - 칼림도어"
L["ATLAS_FLIGHTROUTES_HORDE_EAST"] = "호드 비행 - 동부 왕국"
L["ATLAS_FLIGHTROUTES_HORDE_WEST"] = "호드 비행 - 칼림도어"
L["ATLAS_FLIGHTROUTES_SHIP_ROUTES"] = "배 경로"
L["ATLAS_FLIGHTROUTES_SHIP_ALLIANCE"] = "배 - 얼라이언스"
L["ATLAS_FLIGHTROUTES_SHIP_HORDE"] = "배 - 호드"
...
L["ATLAS_FOREVER_HALL_OF_THANES"] = "대장장이의 전당 (Forever)"
L["ATLAS_FOREVER_RUINS_OF_LORDAERON"] = "로데론의 폐허 (Forever)"
L["ATLAS_FOREVER_DALARAN_CITY"] = "달라란 (Forever)"
L["ATLAS_FOREVER_HALL_OF_THANES_LOC"] = "아이언포지 깊은 곳"
L["ATLAS_FOREVER_RUINS_OF_LORDAERON_LOC"] = "티리스팔의 숲"
L["ATLAS_FOREVER_DALARAN_CITY_LOC"] = "알터랙 산맥"
L["ATLAS_FOREVER_HALL_OF_THANES_DESC"] = "드워프 도시 아래, 오래된 아이언포지에서 고대 왕들이 잠든 전당이 열립니다. 무언가 아래에서 깨어났고 드워프들은 전혀 기쁘지 않습니다."
L["ATLAS_FOREVER_RUINS_OF_LORDAERON_DESC"] = "언더시티 위의 로데론 왕국의 잔해. 궁전의 잔해 사이에 적들이 여전히 숨어 있고, 포세이큰은 도시를 되찾고 싶어합니다."
L["ATLAS_FOREVER_DALARAN_CITY_DESC"] = "달라란을 보호하던 장벽이 물러졌습니다. 도시는 재걸되었지만 완전히 통제되지는 않았고, 키린 토는 질서를 회복할 사람이 필요합니다."
...
L["ATLAS_HTGT_BLACKFATHOM_LOC"] = "잿빛 골짜기"
L["ATLAS_HTGT_RAGEFIRE_LOC"] = "오그리마"
L["ATLAS_HTGT_RAZORFEN_LOC"] = "남부 불모의 땅"
L["ATLAS_HTGT_SHADOWFANG_LOC"] = "은빛소나무 숲"
L["ATLAS_HTGT_STOCKADE_LOC"] = "스톰윈드"
L["ATLAS_HTGT_WAILING_LOC"] = "북부 불모의 땅"
L["ATLAS_DDL_HTGT"] = "가는 방법"
L["ATLAS_FOREVER_EXCAVATION_SITE"] = "발굴 현장 (Forever)"
L["ATLAS_FOREVER_EXCAVATION_SITE_LOC"] = "동부 왕국"
